...
> **Note:** You do *not* need Claude Code installed on your host. The container image builds it in via the native installer, so it's ready to go as soon as the container starts.
